...
var (
	productDBTypes = map[string]string{`ID`: `bigint`, `Brand`: `character varying`, `Madein`: `character varying`, `Name`: `character varying`, `Price`: `double precision`, `CateID`: `bigint`}
	_              = bytes.MinRead
)
