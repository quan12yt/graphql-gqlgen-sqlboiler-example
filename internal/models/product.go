...
type Product struct {
	...
	Madein null.String `boil:"madein" json:"madein,omitempty" toml:"madein" yaml:"madein,omitempty"`
	Name   null.String `boil:"name" json:"name,omitempty" toml:"name" yaml:"name,omitempty"`
	Price  float64     `boil:"price" json:"price" toml:"price" yaml:"price"`
	CateID null.Int64  `boil:"cate_id" json:"cate_id,omitempty" toml:"cate_id" yaml:"cate_id,omitempty"`
...
var ProductWhere = struct {
	...
	Madein whereHelpernull_String
	Name   whereHelpernull_String
	Price  whereHelperfloat64
	CateID whereHelpernull_Int64
}{
	ID:     whereHelperint64{field: "\"product\".\"id\""},
	Brand:  whereHelpernull_String{field: "\"product\".\"brand\""},
	Madein: whereHelpernull_String{field: "\"product\".\"madein\""},
	Name:   whereHelpernull_String{field: "\"product\".\"name\""},
	Price:  whereHelperfloat64{field: "\"product\".\"price\""},
	CateID: whereHelpernull_Int64{field: "\"product\".\"cate_id\""},
}
...
var (
	productAllColumns            = []string{"id", "brand", "madein", "name", "price", "cate_id"}
	productColumnsWithoutDefault = []string{"brand", "madein", "name", "price", "cate_id"}
